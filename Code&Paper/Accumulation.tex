...
% Word target: 7,500 words (currently 7,116)

% I.   Introduction (~850) (currently ~850)
% II. Theoretical background (~1,400 words) (currently 1,400)
% III. Background and Data (~1,500 words) (currently 1,500)
 % IV. Methodology (~1,500 words) (currently 1,500)
% V.  Results (~1,500 words) (currently 1,500)
...
% (2) Write conclusions
% (3) General
%	- Double check all statistics (namely observation numbers)
%	- Double check little examples in the methods section
%	- Non-linear effects
...
% Outline:
% Land inequality is of policy interest
