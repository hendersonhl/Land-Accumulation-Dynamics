...
% I.   Introduction (~750) (currently ~700)
%        a . Consequences of inequality are well understood
%        b.  Causes of inequality are less clear

% Land titling helped activate land markets
% Our analysis may inform future policy but also help the understanding of 
% existing initiatives
% Analysis of the impact of titling on land rental markets is an exception
...
empirical scrutiny.
%\footnote{Though a large body of empirical work has explored, for example, 
%the farm size-productivity relationship, the investment effects of tenure insecurity, 
%or the organizational implications of producer life cycles, little effort 
%has been devoted to examining their implications for dynamism in the 
%distribution of agricultural landholdings.
%See \citet{barrett2010} for review of the literature on the farm 
%size-productivity relationship, \citet{deininger2009} on tenure insecurity, 
%and \citet{gale1994} on the life cycle hypothesis.}

%Consider, for example, one of the most influential theories of firm (or farm)
%growth dynamics, which is known as ``Gibrat's Law of Proportionate Effects.'' 
...
%The theory has received considerable empirical attention in a developed 
%country setting. 
...
%Consider, for example, institutional/legal considerations and the empirical 
%literature exploring the accumulation effects of land tenure insecurity.

%Empirically, a positive association between agricultural investment and tenure 
%security is commonly observed and has been documented in Africa 
%\citep{besley1995, deininger2006, deininger2008, goldstein2008, fenske2011}, 
%Asia \citep{feder1988, jacoby2002, besley2012}, Latin America 
%\citep{deininger2004, bandiera2007, schweigert2007}, as well as Eastern 
%Europe \citep{rozelle2004}.
